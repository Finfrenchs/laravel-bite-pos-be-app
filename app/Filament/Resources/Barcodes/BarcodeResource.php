...
use App\Filament\Resources\Barcodes\Pages\ViewBarcode;
use App\Filament\Resources\Barcodes\Schemas\BarcodeForm;
use App\Filament\Resources\Barcodes\Schemas\BarcodeInfolist;
...
class BarcodeResource extends Resource
{
    ...
    {
        return BarcodeInfolist::configure($schema);
    }
